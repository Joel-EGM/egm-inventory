                    ...
                    <div class="flex flex-wrap -mx-6">
                        <div class="w-full px-6 sm:w-1/2 xl:w-1/4">
                            <div class="flex items-center px-5 py-6 rounded-md bg-white">
                                ...
                                <div class="mx-5">
                                    ...
                                    <h4 class="text-2xl font-bold text-gray-700">8,282</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/4 xl:mt-0">
                            <div class="flex items-center px-5 py-6 rounded-md bg-white">
                                ...
                                <div class="mx-5">
                                    <div class="text-gray-500 text-sm font-bold">Active Order</div>
                        ...
                        <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/4 sm:mt-0">
                            <div class="flex items-center px-5 py-6 rounded-md bg-white">
                                ...
                                <div class="mx-5">
                                    <div class="text-gray-500 text-sm font-bold">Pending Order</div>
                                    <h4 class="text-2xl font-bold text-gray-700">200,521</h4>
                                </div>
                            </div>
                        </div>
