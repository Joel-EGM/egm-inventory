...
<div class="grid grid-cols-6">
    <div class="col-span-6 sm:col-span-6 lg:col-span-6 p-2">
        ...
        <x-jet-input wire:model="name" x-ref="name" id="name" type="text" maxlength="50" class="mt-1 block w-full"
            autocomplete="name" />
    ...
    <div class="col-span-6 sm:col-span-6 lg:col-span-6 p-2">
        ...
        <x-jet-input wire:model="email" x-ref="email" id="email" type="text" maxlength="50"
    ...
    <div class="col-span-6 sm:col-span-6 lg:col-span-6 p-2">
        ...
        <x-jet-input wire:model="password" x-ref="password" id="password" type="text" maxlength="50"
    ...
    <div class="col-span-6 sm:col-span-6 lg:col-span-6 p-2">
        ...
        <x-jet-input wire:model="password_confirmation" x-ref="password_confirmation" id="password_confirmation"
